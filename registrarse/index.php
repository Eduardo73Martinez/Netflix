...
<body>
    <div class="upper">
        ...
        <div class="login-div">
            <form class="login" action="insertar_registro.php" method="get">
                <h1>Sign up</h1>
                ...
                <div class="input-text">
                    ...
                    <div class="martin" >
                         <input type="password" id="password2" name="password2" placeholder="Password" onfocus="inputOnFocus(this)" onblur="inputOnBlur(this)"/>
                    </div>
                ...
                <div class="new-members">
                    do you already have an account?? <a href="#" class="signup-link">Sign in</a>.
                </div>
